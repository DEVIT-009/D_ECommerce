...
async function handleSubmit() {
  ...
  if (!state.error && !state.isLoading) {
    // Add local storage
    userStore.setID(state.users.id);

    userStore.setUserData(userState);
    userStore.setPhone(userState.phone);
    userStore.setEmail(userState.email);
    userStore.setPassword(userState.password);
    userStore.setImage(userState.image);
    userStore.setPosition(userState.position);
    ...
    >
      ...
      >
        ...
        <div class="w-full flex justify-end gap-2">
          <RouterLink to="/login" class="btn btn-primary btn-outline">
            Login
          </RouterLink>
