...
<template>
  <footer class="bg-base-300 text-base-content w-full">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <!-- Bottom Bar -->
      <div
        class="border-t border-base-content/10 mt-8 pt-8 text-center text-base-content/70"
      >
        <p>
